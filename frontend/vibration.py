...
class Vibration:
    ...
    def create_ui(self):
        ...
        tk.Label(
            monitor_frame,
            text="Real-time machine vibration monitoring",
            font=("Arial", 10),
            bg="white",
            fg="#64748B"
        ).pack(
        ...
        self.normal_box = self.analysis_box(
            analysis_frame,
            "NORMAL CONDITION",
            "Machine vibration is within\n"
            "the expected range.",
            "#16A34A"
        )
        ...
        tk.Label(
            self.page,
            text=(
                "Vibration data will be received from "
